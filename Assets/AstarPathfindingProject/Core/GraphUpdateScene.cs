...
namespace Pathfinding {
	...
	public class GraphUpdateScene : GraphModifier {
        ...
        public GraphUpdateObject prevGuo;
		...
		public void Start () {
            ...
            if (applyOnScan)
                InvokeRepeating("Apply", 1, 0.2f);

            //prevGuo = new GraphUpdateObject();
        }
		...
		public void Apply () {
            ...
            //prevGuo.modifyWalkability = modifyWalkability;
            //prevGuo.setWalkability = setWalkability;
            //prevGuo.addPenalty = penaltyDelta;
            //prevGuo.updatePhysics = updatePhysics;
            //prevGuo.updateErosion = updateErosion;
            //prevGuo.resetPenaltyOnPhysics = resetPenaltyOnPhysics;

            //prevGuo.modifyTag = modifyTag;
