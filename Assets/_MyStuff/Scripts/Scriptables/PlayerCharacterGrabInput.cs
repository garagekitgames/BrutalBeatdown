...
{
    [CreateAssetMenu(menuName = "GarageKitGames/Actitons/PlayerGrabInput")]
    public class PlayerCharacterGrabInput : CharacterAction
    {
        ...
        public override void OnUpdate(CharacterThinker character)
        {
            ...
            //Debug.Log("After pullForceVector : " + character.pullForceVector);
