        ...
        public override void OnUpdate(CharacterThinker character)
        {
            ...
            else
            {
                if (!character.targetting)
                {
                    ...
                    chestPart.BodyPartFaceDirection.facingDirection = currentFacing;//inputDirection;//currentFacing;
                    if (useHipToFaceTarget)
                        hipPart.BodyPartFaceDirection.facingDirection = currentFacing;//inputDirection;//currentFacing;
                    if (useHeadToFaceTarget)
                        headPart.BodyPartFaceDirection.facingDirection = currentFacing;//inputDirection;//currentFacing;
                }
                else
                {
                    if (useChestToFaceTarget)
