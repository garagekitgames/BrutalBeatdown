       ...
       // public bool enableDrag;
        ...
        public override void OnUpdate(CharacterThinker character)
        {
            ...
            if (!character.health.alive || character.health.knockdown || character.isHurting)// if (character.health.knockdown) //if( !character.health.alive || character.health.knockdown || character.isHurting)
            {
                ...
                /* if (character.player.GetAxis("MoveHorizontal") > 0) //(character.input.HoldRight())
                 {
                 ...
                 if (character.player.GetAxis("MoveHorizontal") < 0) //(character.input.HoldLeft())
                 {
                 ...
                 if (character.player.GetAxis("MoveVertical") > 0) //(character.input.HoldUp())
                 {
                     inputDirection += Vector3.forward;

                 }

                 if (character.player.GetAxis("MoveVertical") < 0) //(character.input.HoldDown())
                 {
            ...
            {
                //Debug.Log("Before " + inputDirection);
               ...
               // Debug.Log("After " + inputDirection);
