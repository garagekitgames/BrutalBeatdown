    ...
    public class PlayerCharacterSimpleAttackOutputAI : CharacterAction
    {
        ...
        public override void OnFixedUpdate(CharacterThinker character)
        {
            ...
            if (attack)
            {
                ...
                if (attackTimer >= currentAttack.attackSpeed * 0.4f && attackTimer < currentAttack.attackSpeed * 0.6f)
                {
                ...
                if (attackTimer >= currentAttack.attackSpeed * 0.6f && attackTimer < currentAttack.attackSpeed * 1f)
                {
