...
namespace garagekitgames
{
    ...
    public class CharacterHealth : CharacterHealthManager
    {
        ...
        private void Update()
        {
            ...
            {
                if(GameFramework.GameStructure.GameManager.Instance != null)
                {
                    GameFramework.GameStructure.GameManager.Instance.Player.Health = currentHP / maxHP;
