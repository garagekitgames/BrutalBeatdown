...
namespace garagekitgames{
    ...
    public class BodyPartMono : MonoBehaviour
    {
       ...
       // public GrabCheck bodyPartGrabCheck;
      //  public InteractableObject bodyInteractableObject;
        ...
        */
        ...
        public GrabCheck BodyPartGrabCheck
        {
            get { return bodyPartGrabCheck; }
            set { bodyPartGrabCheck = value; }
        }

        public InteractableObject bodyPartInteractableObject;

        public InteractableObject BodyPartInteractableObject
        {
            get { return bodyPartInteractableObject; }
            set { bodyPartInteractableObject = value; }
        }
        ...
        /* private void OnCollisionStay(Collision collision)
         {
             ...
             {
                 //once = true;
                 if (collisiontransform.tag.Contains("Ground"))
                 {
                     myBrain.grounded = true;
        ...
        private void GroundCheck(Transform collisionTransform, Rigidbody collisionRigidbody, Collider collisionCollider, ContactPoint[] collisionContacts, Vector3 relativeVelocity, float velocityMagnitude)
        {
            ...
            for (int i = 0; i < collisionContacts.Length; i++)
            {
                ...
                if (collisionTransform.CompareTag("Ground"))
                {
