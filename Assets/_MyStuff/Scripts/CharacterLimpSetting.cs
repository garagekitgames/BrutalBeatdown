    ...
    public class CharacterLimpSetting : MonoBehaviour
    {
        ...
        public IEnumerator LerpToAngle()
        {
            ...
            if (!looseCharacter)
            {
                ...
                float angle = Quaternion.Angle(bodyPartMono2.bodyPartTransform.rotation, _targetRotation);
                while (!(Mathf.Approximately(angle, 0)))//currentYAngle == targetRotation
                {
                   ...
                   // bodyPartMono2.bodyPartTransform.eulerAngles = new Vector3(bodyPartMono2.bodyPartTransform.localRotation.x, angle, 0);
                    ...
                    angle = Quaternion.Angle(bodyPartMono2.bodyPartTransform.rotation, _targetRotation);
        ...
        public void resetLimp()
        {
            ...
            if (!looseCharacter)
            {
                ...
                //StartCoroutine(LerpToAngle(bodyPartMono2));
