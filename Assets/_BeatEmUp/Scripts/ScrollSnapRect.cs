...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    void Start() {
        ...
        Debug.Log("Selected Level : " + (GameManager.Instance.Levels.Selected.Number - 1));
        //SetPageSelection(GameManager.Instance.Levels.Selected.Number - 1);

        //SetPage(GameManager.Instance.Levels.Selected.Number - 1);

        LerpToPage((GameManager.Instance.Levels.Selected.Number - 1) / 10);
